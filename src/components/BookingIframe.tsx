...
const BookingIframe: React.FC<BookingIframeProps> = ({ bookingUrl, serviceName, onClose }) => {
  ...
  useEffect(() => {
    ...
    const updateHeights = () => {
      ...
      const navigationHeight = 80; // Bottom navigation height
      const availableHeight = vh - headerHeight - navigationHeight;
  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        <motion.div 
          ref={containerRef}
          className="iframe-container relative bg-white overflow-hidden"
          onTouchStart={handleTouchStart}
          style={{ 
            height: 'calc(100vh - 48px - 80px)', // Header (48px) + Navigation (80px)
